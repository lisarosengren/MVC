 ...
 */
final class Version20250603083308 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TEMPORARY TABLE __temp__item AS SELECT id, room_id, examine_reveal_id, combination_reveal_id, combo_id, examine, deadly, pickable, comb_text, is_last, hidden FROM item
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE item
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO item (id, room_id, examine_reveal_id, combination_reveal_id, combo_id, examine, deadly, pickable, comb_text, is_last, hidden) SELECT id, room_id, examine_reveal_id, combination_reveal_id, combo_id, examine, deadly, pickable, comb_text, is_last, hidden FROM __temp__item
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE item (id VARCHAR(25) NOT NULL, room_id VARCHAR(255) NOT NULL, examine_reveal_id VARCHAR(25) DEFAULT NULL, combination_reveal_id VARCHAR(25) DEFAULT NULL, combo_id VARCHAR(25) DEFAULT NULL, examine VARCHAR(255) NOT NULL, deadly BOOLEAN NOT NULL, pickable BOOLEAN NOT NULL, comb_text VARCHAR(255) DEFAULT NULL, is_last BOOLEAN NOT NULL, hidden BOOLEAN DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_1F1B251E54177093 FOREIGN KEY (room_id) REFERENCES room (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1F1B251EDED7BB1F FOREIGN KEY (examine_reveal_id) REFERENCES item (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1F1B251EF3E67B23 FOREIGN KEY (combination_reveal_id) REFERENCES item (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1F1B251EEB6587E3 FOREIGN KEY (combo_id) REFERENCES item (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO item (id, room_id, examine_reveal_id, combination_reveal_id, combo_id, examine, deadly, pickable, comb_text, is_last, hidden) SELECT id, room_id, examine_reveal_id, combination_reveal_id, combo_id, examine, deadly, pickable, comb_text, is_last, hidden FROM __temp__item
        SQL);
