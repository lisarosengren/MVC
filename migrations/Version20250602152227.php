 ...
 */
final class Version20250602152227 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE room ADD COLUMN second_description VARCHAR(255) DEFAULT NULL
        SQL);
    }
}
