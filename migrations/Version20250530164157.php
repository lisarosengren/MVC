 ...
 */
final class Version20250530164157 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE item ADD COLUMN examine_reveal VARCHAR(25) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE item ADD COLUMN combination VARCHAR(25) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
