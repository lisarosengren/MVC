 ...
 */
final class Version20250530173909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE item (id VARCHAR(25) NOT NULL, room_id VARCHAR(255) NOT NULL, examine_reveal_id VARCHAR(25) DEFAULT NULL, combination_id VARCHAR(25) DEFAULT NULL, combination_reveal_id VARCHAR(25) DEFAULT NULL, examine VARCHAR(255) NOT NULL, deadly BOOLEAN NOT NULL, pickable BOOLEAN NOT NULL, comb_text VARCHAR(255) DEFAULT NULL, is_last BOOLEAN NOT NULL, hidden BOOLEAN DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_1F1B251E54177093 FOREIGN KEY (room_id) REFERENCES room (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1F1B251EDED7BB1F FOREIGN KEY (examine_reveal_id) REFERENCES item (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1F1B251E7D949DCC FOREIGN KEY (combination_id) REFERENCES item (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1F1B251EF3E67B23 FOREIGN KEY (combination_reveal_id) REFERENCES item (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
